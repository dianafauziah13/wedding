...
<template>
            ...
            >
              <center>
                <figure class="inv-image bride-photo">
                  ...
                  <img class="is-rounded inv-spin" src="frontend/images/ansor.png" />
                </figure>
          ...
          <div class="inv-grid grid-parent">
            ...
            >
              <center>
                <figure class="inv-image bride-photo">
                  <!-- <img class="has-ratio" width="200" src="https://assets.promediateknologi.com/crop/0x0:0x0/x/photo/2022/02/24/180111210.jpg" /> -->
                  <img class="is-rounded inv-spin" src="frontend/images/narisha.png" />
                </figure>
              ...
              <div class="inv-grid grid-vertical">
                  ...
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="frontend/images/gallery-1.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="frontend/images/gallery-2.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="frontend/images/gallery-3.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="frontend/images/gallery-4.png" />
                      </figure>
                    </div>
                  </div>
                </div>
                <div class="inv-grid grid-parent">
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="frontend/images/gallery-5.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="frontend/images/gallery-6.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="frontend/images/gallery-7.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="frontend/images/gallery-8.png" />
                      </figure>
                    </div>
                  </div>
                </div>
          ...
          <div class="inv-slider">
            <div class="inv-slides">
              ...
              <div class="inv-slide first">
                <img src="frontend/images/slider-1.png" alt="slider-1" />
              </div>
              <div class="inv-slide">
                <img src="frontend/images/slider-2.png" alt="slider-2" />
              </div>
              <div class="inv-slide">
                <img src="frontend/images/slider-3.png" alt="slider-3" />
              </div>
              <div class="inv-slide">
                <img src="frontend/images/slider-4.png" alt="slider-4" />
              </div>
              <div class="inv-slide">
                <img src="frontend/images/slider-5.png" alt="slider-5" />
              </div>
            </div>
  ...
  <audio>
    <source src="frontend/audio/NOTHINGS GONNA CHANGE MY LOVE FOR YOU  GLENN MEDEIROS.mp3" type="audio/mp3" />
  </audio>
</template>
