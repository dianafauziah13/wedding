  ...
  <body>
    <div class="inv-envelope">
      <div class="inv-envelope-content-wrapper">
        ...
        <button id="open-env" class="btn-open-env" @click="openEnvelope()">Buka Undangan</button>
      </div>
    </div>
            ...
            >
              <center>
                <figure class="inv-image bride-photo">
                  ...
                  <img class="is-rounded inv-spin" src="/assets/frontend/images/ansor.png" />
                </figure>
          ...
          <div class="inv-grid grid-parent">
            ...
            >
              <center>
                <figure class="inv-image bride-photo">
                  <!-- <img class="has-ratio" width="200" src="https://assets.promediateknologi.com/crop/0x0:0x0/x/photo/2022/02/24/180111210.jpg" /> -->
                  <img class="is-rounded inv-spin" src="/assets/frontend/images/narisha.png" />
                </figure>
              ...
              <div class="inv-grid grid-vertical">
                  ...
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="/assets/frontend/images/gallery-1.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="/assets/frontend/images/gallery-2.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="/assets/frontend/images/gallery-3.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="/assets/frontend/images/gallery-4.png" />
                      </figure>
                    </div>
                  </div>
                </div>
                <div class="inv-grid grid-parent">
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="/assets/frontend/images/gallery-5.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="/assets/frontend/images/gallery-6.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="/assets/frontend/images/gallery-7.png" />
                      </figure>
                    </div>
                  </div>
                  <div class="inv-grid grid-parent">
                    <div class="inv-grid grid-node inv-reveal-rand">
                      <figure class="inv-image is-md-width-rectangle">
                        <img width="800" src="/assets/frontend/images/gallery-8.png" />
                      </figure>
                    </div>
                  </div>
                </div>
          ...
          <div class="inv-slider">
            <div class="inv-slides">
              ...
              <div class="inv-slide first">
                <img src="/assets/frontend/images/slider-1.png" alt="slider-1" />
              </div>
              <div class="inv-slide">
                <img src="/assets/frontend/images/slider-2.png" alt="slider-2" />
              </div>
              <div class="inv-slide">
                <img src="/assets/frontend/images/slider-3.png" alt="slider-3" />
              </div>
              <div class="inv-slide">
                <img src="/assets/frontend/images/slider-4.png" alt="slider-4" />
              </div>
              <div class="inv-slide">
                <img src="/assets/frontend/images/slider-5.png" alt="slider-5" />
              </div>
            </div>
    ...
    <footer class="invite-footer">
      <div class="inv-column-6 footer-copy">
        &copy; 2023, Resepsi Digital. All Rights Reserved.
      </div>
    </footer>
  </body>
  <audio>
    <source src="/assets/frontend/audio/music.mp3" type="audio/mp3" />
  </audio>
</template>
...
export default {
  name: "Master",
  mounted() {
    const cnt = new Countdown("cntd", new Date("2023-5-14 23:59:59 GMT+0700"));
